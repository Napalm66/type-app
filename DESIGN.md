...
- **Mobile override:** at `max-width: 640px`, `.hero-text` gets `padding-top: 21%` instead of the desktop 15% — mobile's narrower column wraps the brand differently, which put "Classified" across the subject's chin rather than his wrist; the mobile-only bump pushes it back down to clear his chin while leaving the desktop composition (touching the wrist) untouched.
