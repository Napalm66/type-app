...
A field guide to type classification, built for the web. Explore the major typeface classifications — Blackletter, Oldstyle (Venetian & Garalde), Transitional, Modern (Didone), Slab Serif, Sans-Serif subtypes, Glyphic, Script, and Display — with visual diagnostics, an interactive quiz, and a historical timeline.
...
- **Practice** — a multiple-choice quiz that tests your ability to recognize a classification from its specimen.
...
js/explore.js       js/identify.js       js/practice.js
js/timeline.js       js/compare.js       js/detail.js
js/anatomy.js       js/magnifier.js       js/specimen.js
