...
const CLASSIFICATIONS = [
  ...
  },
  {
    ...
    diagnostics: {
      ...
      serif: "none",
      tell: "Open apertures, some stroke modulation, often a two-story 'a' following the classic, traditional form seen in handwriting and calligraphic scripts which feels closer to a serif face without the serifs.",
    },
    visualCharacteristics: [
      { label: "Terminals", text: "The ends of strokes may be rounded, squared, or angled." },
      { label: "Serifs", text: "No serifs." },
