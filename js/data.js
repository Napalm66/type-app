...
const CLASSIFICATIONS = [
  ...
  },
  {
    ...
    visualCharacteristics: [
      { label: "Terminals", text: "The ends of strokes may be pointed, rounded, angled, or may end in a teardrop or ball shape, but generally lighter, sharper, and straighter than Humanist or Venetian Oldstyle." },
      { label: "Serifs", text: "Usually more lightly bracketed and straighter than Humanist or Venetian Oldstyle." },
      { label: "Stress", text: "Usually oblique." },
      { label: "Contrast", text: "There is a low to medium contrast between thick and thin strokes." },
      { label: "X-height", text: "Generally medium in relation to the cap height." },
      { label: "Set width", text: "Characters tend to be moderate to wide." },
      { label: "Positive/Negative space", text: "Increased spacing and counters give a slightly lighter overall appearance than Humanist or Venetian Oldstyle." },
    ],
    additionalFeatures: [
      "Somewhat organic but more precise than Humanist or Venetian Oldstyle",
  ...
  },
  {
    ...
    diagnostics: {
      ...
      axis: "barely-oblique",
      serif: "none",
      tell: "Open apertures, a faint trace of stroke modulation, often a two-story 'a' following the classic, traditional form seen in handwriting and calligraphic scripts which feels closer to a serif face without the serifs — but both contrast and stress are far more subtle here than in an Old Style serif like Venetian.",
    },
    visualCharacteristics: [
      { label: "Terminals", text: "The ends of strokes may be rounded, squared, or angled." },
      { label: "Serifs", text: "No serifs." },
      { label: "Stress", text: "Only barely oblique — a faint trace of the calligraphic angle, far more subtle than an Old Style serif's." },
      { label: "Contrast", text: "Very low contrast between thick and thin strokes, nearly uniform." },
      { label: "X-height", text: "Generally tall in relation to the cap height." },
      { label: "Set width", text: "Characters tend to be moderate to wide." },
    ],
    additionalFeatures: [
